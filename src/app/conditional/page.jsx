...
const Video = () => {
	return (
		<>
			<div className='flex'>
				<h1 className='p-20 ttt font-black text-5xl'>Title: {"Js conditional and control statements "}</h1>
				<Link href={'/pythonbeg'}>
			...
			<div className='flex justify-center space-x-2 p-10' >
				<iframe
					width='1200'
					height='600'
					src='https://www.youtube.com/embed/uu4eM04vvxc?si=5jF_l33wkFly2PTZ'
