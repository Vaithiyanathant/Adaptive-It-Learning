...
const Video = () => {
	return (
		<>
			<div className='flex'>
				<h1 className='p-20 ttt font-black text-5xl'>Title: {"Lambda Functions and list Comprehension"}</h1>
				<Link href={'/pythonadv'}>
			...
			<div className='flex justify-center space-x-2 p-10' >
				<iframe
					width='1200'
					height='600'
					src='https://www.youtube.com/embed/P8MdDCTbMOI?si=nXQnxe3DG7j3lBLA'
